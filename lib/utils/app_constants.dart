class AppConstants {
  ...
  static const double DELIVERY_CHARGE_PERCENTAGE = 0.1;
  ...
  //SignUp endpoint URI
  static const String REGSTRATION_URI =
      "/api/v1/auth/register"; // 디렉토리를 잘 기억해두자.. Larabel 에 등록해주어야 한다.
  static const String LOGIN_URI =
      "/api/v1/auth/login"; // 디렉토리를 잘 기억해두자.. Larabel 에 등록해주어야 한다.
