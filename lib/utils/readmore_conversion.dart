...
class ReadMoreTextConversion extends StatefulWidget {
  ReadMoreTextConversion(
      this.data, {
        Key? key,
        this.preDataText,
        this.postDataText,
        ...
        this.trimLength = 240,
        this.trimLines = 2,
        this.trimMode = TrimModeC.Length,
        this.style,
        this.textAlign,
        this.textDirection,
        this.locale,
  ...
  @override
  ReadMoreTextConversionState createState() => ReadMoreTextConversionState();
}
...
class ReadMoreTextConversionState extends State<ReadMoreTextConversion> {

  void _onTapLink() {
    setState(() {
      widget._readMore = !widget._readMore;
      widget.callback?.call(widget._readMore);
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    TextSpan link = TextSpan(
      text: widget._readMore ? widget.trimCollapsedText : widget.trimExpandedText,
      style: widget._readMore ? _defaultMoreStyle : _defaultLessStyle,
      recognizer: TapGestureRecognizer()..onTap = _onTapLink,
    );

    TextSpan _delimiter = TextSpan(
      text: widget._readMore
